...
(function() {
  var contentLinkElement, destroyFormContainer, findContentLink, root;

  root = typeof exports !== "undefined" && exports !== null ? exports : this;

  contentLinkElement = null;

  findContentLink = function() {
    return contentLinkElement = $("a[href*=\"" + location.pathname + "\"]");
  };
  ...
  $(function() {
    ...
    $(document).on('itemremoved', 'table.data-table a.action_destroy', function(e) {
      ...
      if ($('tbody tr', table).length <= 1 && $('select.offset option:last', table).is(':selected')) {
