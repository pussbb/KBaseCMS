...
(function() {
  var Article, Articles, ArticlesList, ArticlesView, Month, MonthView, Months, MonthsList, Year, YearView, Years, YearsList, mothList,
  ...
  $(function() {
    var App, AppView, articlesList, yearList;
    yearList = $("#years-list");
