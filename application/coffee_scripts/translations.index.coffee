...
$ ->
  $("a.inline_edit").live 'click', (e)->
    ...
    <span class=\"label label-success save\"><i class=\"icon-ok\"></i> Save</span>
    <span class=\"label label-inverse cancel\"><i class=\"icon-minus-sign\"></i> Cancel</span>
    </form>"
    $("span.translation", parent).html html
    $("span.translation textarea", parent).width($("span.translation", parent).width()-10)
